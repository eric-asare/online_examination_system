...
/**
 * Class represents the GUI with options for a Grader to select a particular student answer to grade. 
 */
public class GraderSelectAnswerGUI extends JFrame {
    ...
    public GraderSelectAnswerGUI() {
        setTitle("Grader Select Answer GUI");
        setSize(800, 800);
        ...
        selectStudentBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GradeAnswerGUI frame = new GradeAnswerGUI();
