...
/**
 * The class represents the interface for the Grader to select which regrade requests from students to respond to.
 */
public class SelectRequestGUI extends JFrame {
    ...
    public SelectRequestGUI() {
        setTitle("Select Request GUI");
        setSize(800, 800);
        ...
        requestSelectBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ViewRequestGUI frame = new ViewRequestGUI();
